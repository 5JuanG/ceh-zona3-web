    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/70 backdrop-blur-sm overflow-y-auto">
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden my-auto">
          ...
          {/* Form Body */}
          <form onSubmit={handleSave} className="p-5 overflow-y-auto space-y-5 flex-1 text-base">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end pt-4">
                  <button
                    type="button"
                    onClick={() => setActiveTab('paciente')}
                    className="inline-flex items-center gap-1 px-4 py-2 bg-slate-900 text-white font-bold rounded-lg text-sm hover:bg-slate-800"
                  >
            ...
            {activeTab === 'paciente' && (
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-3">
                  <h4 className="font-bold text-slate-800 text-sm uppercase tracking-wide border-b border-slate-200 pb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex items-center gap-2 bg-white p-2 rounded-lg border border-slate-200">
                      ...
                      />
                      <label className="flex items-center gap-1 shrink-0 text-sm font-semibold text-slate-700">
                        <input
                          type="checkbox"
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 pt-2 border-t border-slate-200">
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 mb-0.5">Peso al nacer</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 mb-0.5">Edad gestacional (semanas)</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 mb-0.5">Fecha de nacimiento</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 mb-0.5">APGAR al nacimiento</label>
                      <input
                        type="text"
                        placeholder="Ej. 8/10"
                        value={apgarBirth}
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-600 mb-0.5">APGAR a los 5 minutos</label>
                      <input
                        type="text"
                        placeholder="Ej. 9/10"
                        value={apgar5Min}
                ...
                <div className="flex justify-between pt-4">
                  <button
                    type="button"
                    onClick={() => setActiveTab('notificacion')}
                    className="px-4 py-2 bg-slate-200 text-slate-800 font-bold rounded-lg text-sm hover:bg-slate-300"
                  >
                    Anterior
                  </button>
                  <button
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-200 pb-1">
                    ...
                    <button
                      type="button"
                      onClick={addLabRow}
                      className="inline-flex items-center gap-1 px-2.5 py-1 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded text-sm"
                    >
                    ...
                    {labResults.map((lab, idx) => (
                      <div key={idx} className="bg-white p-2.5 rounded-lg border border-slate-300 grid grid-cols-1 sm:grid-cols-12 gap-2 items-center">
                        <div className="sm:col-span-3">
                          <label className="block text-xs font-semibold text-slate-500">Fecha/Hora de Análisis</label>
                          <input
                            type="text"
                            placeholder="Ej. 05/08 - 08:00"
                            value={lab.dateTime}
                            onChange={(e) => updateLabRow(idx, 'dateTime', e.target.value)}
                            className="w-full bg-slate-50 border border-slate-300 rounded p-1 text-sm"
                          />
                        </div>

                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-500">Hb (g/dl)</label>
                          <input
                            type="text"
                            placeholder="Ej. 8.5"
                            value={lab.hemoglobin}
                            onChange={(e) => updateLabRow(idx, 'hemoglobin', e.target.value)}
                            className="w-full bg-slate-50 border border-slate-300 rounded p-1 text-sm font-bold text-slate-900"
                          />
                        </div>

                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-500">Hto (%)</label>
                          <input
                            type="text"
                            placeholder="Ej. 26%"
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-500">Plaquetas (/μL)</label>
                          <input
                            type="text"
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-500">Otros (INR, TP...)</label>
                          <input
                            type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 border-t border-slate-200">
                    <div className="flex items-center gap-2 bg-white p-2.5 rounded-lg border border-slate-200">
                      <input
                        ...
                        className="w-4 h-4 text-sky-600 rounded"
                      />
                      <label htmlFor="medicalStaffNotifiedHlcHelp" className="font-semibold text-slate-800 cursor-pointer text-sm">
                    ...
                    <div className="flex items-center gap-2 bg-rose-50 p-2.5 rounded-lg border border-rose-200">
                      ...
                      />
                      <label htmlFor="legalActionMentioned" className="font-bold text-rose-900 cursor-pointer text-sm">
            ...
            {activeTab === 'traslado' && (
              <div className="space-y-4">
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black rounded-lg shadow text-sm"
                  >
