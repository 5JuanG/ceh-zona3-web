...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  const navItems: NavItem[] = [
    ...
    // El Panel Admin solo se agrega a la navegación si la cuenta es admin.
    ...(isAdmin ? [{ id: 'admin' as const, label: 'Panel Admin', icon: ShieldCheck }] : []),
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className="hidden md:inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-bold bg-sky-900/90 hover:bg-sky-800 text-sky-200 rounded-lg border border-sky-500/70 shadow-sm transition-all"
            >
              ...
              <span className="lg:hidden">Sync Nube</span>
            </button>
            ...
            {onOpenMemberWorksheetModal && (
              <button
                ...
                className="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-sky-600 hover:bg-sky-500 text-white rounded-lg shadow-sm transition-colors"
              >
                <FileText className="w-4 h-4 text-sky-100" />
                <span className="hidden lg:inline">Hoja Miembro PDF</span>
                <span className="lg:hidden">Hoja PDF</span>
              </button>
            )}
            ...
            <button
              ...
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg border border-slate-700 transition-colors"
            >
          ...
          <div className="grid grid-cols-2 gap-2">
            {onOpenMemberWorksheetModal && (
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-bold bg-sky-600 hover:bg-sky-500 text-white rounded-xl shadow-sm"
              >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-medium bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl border border-slate-700"
            >
              <Printer className="w-4 h-4 text-sky-400" />
              Reporte
            </button>
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-semibold bg-emerald-800/60 hover:bg-emerald-700/60 text-emerald-200 rounded-xl border border-emerald-700/50"
            >
