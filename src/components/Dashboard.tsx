      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-sky-950 text-white rounded-2xl p-6 shadow-lg border border-slate-800">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
  id="btn-nueva-emergencia" // <-- Asegurar este ID explícito
  onClick={(e) => {
    e.preventDefault();
    if (typeof onOpenWorksheetModal === 'function') {
      onOpenWorksheetModal();
    } else {
      console.error("La función onOpenWorksheetModal no fue inyectada al Dashboard");
    }
  }}
  className="inline-flex items-center gap-2 px-4 py-2.5 text-xs font-black bg-red-600 hover:bg-red-700 text-white rounded-xl shadow-xl border border-red-400 cursor-pointer transition-all shrink-0 hover:scale-105"
>
