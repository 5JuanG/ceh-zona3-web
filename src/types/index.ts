...
export type Specialty = 
  // --- Especialidades ya existentes en la app (no remover: hay médicos guardados con estos valores) ---
  | 'Cirugía General'
  | 'Anestesiología'
  | 'Hematología'
  ...
  | 'Bioética'
  | 'Dirección Médica'
  // --- Subespecialidades quirúrgicas (rama de Cirugía General, folleto hlc-9-S) ---
  ...
  // --- Otras especialidades fundamentales (hlc-9-S) ---
...
export interface Doctor {
  ...
  // Ubicación del consultorio/oficina — solo aplica para type 'proveedor_salud'
  // o 'contacto_administrativo' (para poder mostrarlos como pin en el Mapa
  // Interactivo, igual que los hospitales).
